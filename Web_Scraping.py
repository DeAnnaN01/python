...
## Analyzing the HTML. Add a new line in the scrape function which creates a BeautifulSoup object, and pass the html variable and the "html.parser" string as a parameter. 
# def scrape(self):
    # r = urllib.request.urlopen(self.site)
    # html = r.read()
    # parser = "html.parser"
